...
module "lambda_api_gateway" {
  ...
  ENVIRONMENT_VARIABLES               = merge({ content_bucket = module.content_management_bucket.CONTENT_BUCKET, mem_host = module.elasticache_memcached.ELASTICACHE_NODE_ADDRESS, mem_port = module.elasticache_memcached.ELASTICACHE_NODE_PORT_NUMBER }, var.ENVIRONMENT_VARIABLES_LAMBDA_API)
